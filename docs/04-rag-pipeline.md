...
안에 있어도(벡터검색 Recall@35 87.5%) 리랭킹이 놓치는 비율이 16%p 정도 있다(자세한 수치는
[05-evaluation.md](05-evaluation.md#55-검색-품질-오프라인-지표) 참고) — 이 리랭킹 정확도 자체를
더 개선하는 건 향후 과제로 남아 있다.

**압축 폭 35, 최종 개수 5는 이 104건으로 직접 검증했다.** 압축 폭을 40(=벡터검색이 가져온 걸 안
